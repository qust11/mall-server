...
public class CodeGenerator {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/mall_product?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "123456";

    private static final String module = "goods";

    private static final String projectPath = "D:\\code\\java\\mall\\product-center\\product-service";
